    ...
    internal static class Program
    {
        ...
        internal class BankAccount
        {
            ...
            */
            ...
            public string deposit(double amount) // Note verify amount is positive and between 1..1000 (inclusive)
            {
                if (amount >= Constants.MIN && amount <= Constants.MAX)
                {
                    ...
                    return "The amount exceeds the maximum possible deposit!";
            }
            ...
            public string withdraw(double amount)
            {
                if (this.balance >= amount)
                {
                    ...
                    return "You have less money then you want withdraw :(";
            }
